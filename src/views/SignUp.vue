<template>
  <div id="app" class="container">
    ...
    <div class="row mt-5">
      <!-- Information Section -->
      <div class="col-md-6 col-lg-5 d-flex flex-column justify-content-center align-items-center text-center" style="margin-left: -100px;">
        <div class="mb-5">
          <div class="logo-container mb-4">
            <img src="/public/images/checkEaseLogo.png" alt="logo here" style="width: 415px; height: 125px;" class="mt-n5 mh-125px mw-425px">
          </div>
...
export default {
  ...
  methods: {
    submitForm() {
      ...
      console.log('Form Submitted', this.firstname, this.lastname, this.username, this.email, this.password, this.role);
    }
  }
};
</script>
...
.square-1 { top: 10vh; left: 20vw; }
.square-2 { top: 30vh; left: 40vw; }
.square-3 { top: 50vh; left: 60vw; }
.square-4 { top: 70vh; left: 80vw; }
.square-5 { top: 20vh; left: 70vw; }
.square-6 { top: 40vh; left: 90vw; }
.square-7 { top: 60vh; left: 10vw; }
.square-8 { top: 80vh; left: 30vw; }
</style>
